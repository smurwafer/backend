...
Router.post('/api/bookmark', require_auth_1.requireAuth, function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, id, category, bookmark, err_1;
    var _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                bookmark = bookmark_1.Bookmark.build({
