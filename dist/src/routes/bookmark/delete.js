...
Router.delete('/api/bookmark/:id', require_auth_1.requireAuth, function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var id, bookmark, err_1;
    var _a, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                _c.trys.push([0, 3, , 4]);
                id = req.params.id;
                return [4 /*yield*/, bookmark_1.Bookmark.findOne({
            ...
            case 1:
                ...
                return [4 /*yield*/, bookmark_1.Bookmark.findOneAndDelete({
