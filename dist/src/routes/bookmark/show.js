...
Router.get('/api/bookmark/is-bookmarked/:id', require_auth_1.requireAuth, function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var id, bookmark, isBookmarked, err_1;
    var _a;
