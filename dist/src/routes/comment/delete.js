...
Router.delete('/api/comment/:id', function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var id, comment, err_1;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, comment_1.Comment.findByIdAndDelete(id)];
            case 2:
                _b.sent();
                res.status(202).send({
