...
Router.get('/api/dashboard', require_auth_1.requireAuth, function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var leaderboard;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, dashboard_1.Dashboard.find().populate('user').sort({
                    'rating': -1,
                }).limit(5)];
            case 1:
                leaderboard = _a.sent();
