...
Router.get('/api/dashboard/:id', require_auth_1.requireAuth, function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var id, dashboard, casinos, casinoData, i;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                dashboard = _a.sent();
                return [4 /*yield*/, casino_1.Casino.find({ gambler: id, active: false }).sort({
                        'createdAt': 1,
                    })];
            case 2:
                casinos = _a.sent();
                casinoData = [];
                for (i = 0; i < casinos.length; i++) {
                    casinoData.push({
                        casino: (i + 1).toString(),
