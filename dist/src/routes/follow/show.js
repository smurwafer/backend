...
Router.get('/api/follow/is-following/:followed', require_auth_1.requireAuth, function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var followed, id, followingTheUser, userFollowingMe, followText, err_1;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                followingTheUser = _b.sent();
                return [4 /*yield*/, follow_1.Follow.findOne({
                        follower: followed,
                        followed: id,
                    })];
            case 2:
                userFollowingMe = _b.sent();
                followText = 'follow';
