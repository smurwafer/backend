...
Router.delete('/api/story/:id', function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var id, story, gamble, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, story_1.Story.findByIdAndDelete(id)];
            case 2:
                _a.sent();
            ...
            case 3:
                ...
                return [4 /*yield*/, gamble_1.Gamble.findOneAndDelete({
                        story: id,
                    })];
            case 4:
                _a.sent();
