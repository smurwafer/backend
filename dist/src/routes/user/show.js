...
Router.get('/api/user/:id', function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var id, user, err_1;
...
Router.get('/api/profile/:id', function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var id, profile, err_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
