...
Router.post('/api/vote', require_auth_1.requireAuth, function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, type, id, vote, gamble, casino, err_1;
    var _b, _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                ...
                vote = vote_1.Vote.build({
                    type: type,
                    story: id, voter: (_b = req.currentUser) === null || _b === void 0 ? void 0 : _b.id,
                });
