...
Router.delete('/api/vote/:id', require_auth_1.requireAuth, function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var id, vote, gamble, err_1;
    var _a, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                _c.trys.push([0, 5, , 6]);
                id = req.params.id;
                return [4 /*yield*/, vote_1.Vote.findOne({
                        story: id,
            ...
            case 1:
                ...
                return [4 /*yield*/, vote_1.Vote.findOneAndDelete({
                        story: id,
