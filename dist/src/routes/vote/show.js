...
Router.get('/api/vote/:id', require_auth_1.requireAuth, function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var id, upVotes, downVotes, vote, err_1;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 4, , 5]);
                id = req.params.id;
                return [4 /*yield*/, vote_1.Vote.find({
                        story: id,
                        type: 'up',
                    }).countDocuments()];
            case 1:
